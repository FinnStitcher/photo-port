...
function PhotoList({ category }) {
	...
	// filtering down to just the photos for the category currently being displayed
	// this will re-run each time the category updates and the component re-renders
	const currentPhotos = photos.filter(photo => photo.category === category);

    // used to interact with the Modal component
